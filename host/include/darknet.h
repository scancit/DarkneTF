...
typedef struct network{
    ...
    cl_mem_ext pre_input_gpu;
    cl_mem_ext truth_gpu;
    cl_mem_ext pre_truth_gpu;
    cl_mem_ext delta_gpu;
    cl_mem_ext output_gpu;
...
typedef enum {
    CLASSIFICATION_DATA, DETECTION_DATA, CAPTCHA_DATA, IMAGE_DATA, COMPARE_DATA, WRITING_DATA, SWAG_DATA, TAG_DATA, OLD_CLASSIFICATION_DATA, STUDY_DATA, DET_DATA, SUPER_DATA, LETTERBOX_DATA, REGRESSION_DATA, SEGMENTATION_DATA, INSTANCE_DATA
} data_type;
